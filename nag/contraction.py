...
def wc_accelerated_gradient_strongly_convex(mu, L, alpha, beta, n, verbose=1):
    """
    ...
    **References**:
    ...
    problem.set_initial_condition((f1 - fs) + beta * (f0 - fs) <= 1)
    ...
    problem.set_performance_metric((func(x_new) - fs) + beta * (func(x_old) - fs))
